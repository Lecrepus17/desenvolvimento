                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4 mb-md-0">
                                ...
                                <form action="/login.html" method="POST">
                                    ...
                                    <button class="btn btn-primary btn-auth-submit" type="submit">Enviar</button>
                                </form>
                                <p class="mb-0">
                                    <a href="{{ route('bootstrap.register') }}" class="text-dark font-weight-bold">Não possui uma conta? Cadastre-se</a>
                                </p>
                            </div>
